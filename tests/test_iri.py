...
from regen_iri_gen.content_hash import ContentHash
from regen_iri_gen.iri import to_iri, parse_iri


def test_to_iri(
    test_graph_content_hash: (ContentHash, str),
    test_raw_content_hash: (ContentHash, str),
):
