...
from regen_iri_gen.content_hash import (
    ContentHash,
    ContentHashGraph,
    ContentHashRaw,
    DigestAlgorithm,
...
def test_graph_content_hash() -> (ContentHash, str):
    ...
    return (
        ContentHash(graph=content_hash_graph),
...
def test_raw_content_hash() -> (ContentHash, str):
    ...
    return (
        ContentHash(raw=content_hash_raw),
        "regen:113gdjFKcVCt13Za6vN7TtbgMM6LMSjRnu89BMCxeuHdkJ1hWUmy.binA",
    )
